        ...
        <div class="flex flex-wrap -m-4">
            <div class="p-4 lg:w-1/3">
                <div
                    ...
                    <h2 class="tracking-widest text-xs title-font font-medium text-base dark:text-gray-500 mb-1">CATEGORY</h2>
                    <h1 class="title-font sm:text-2xl text-xl font-bold dark:text-white mb-3">Raclette Blueberry
                        Nextious Level</h1>
                    ...
                    <a class="text-indigo-600 dark:text-indigo-400 inline-flex items-center">Learn More
